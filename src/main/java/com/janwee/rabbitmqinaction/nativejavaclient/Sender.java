...
public class Sender {
    public static void main(String[] args) throws Exception {
        ...
        channel.exchangeDeclare(Property.DIRECT_EXCHANGE_NAME, BuiltinExchangeType.DIRECT, true, false, arguments);
        channel.queueDeclare(Property.QUEUE_NAME, true, false, false, null);
        ...
        channel.exchangeDeclare(Property.ALTERNATE_EXCHANGE_NAME, BuiltinExchangeType.FANOUT, true);
        channel.queueDeclare(Property.UNROUTABLE_QUEUE_NAME, true, false, false, null);
        channel.queueBind(Property.UNROUTABLE_QUEUE_NAME, Property.ALTERNATE_EXCHANGE_NAME, "");

        //declare a topic exchange
        channel.exchangeDeclare(Property.TOPIC_EXCHANGE_NAME, BuiltinExchangeType.TOPIC, true);
        channel.queueDeclare(Property.QUEUE_TEXT, true, false, false, null);
        ...
        channel.basicPublish(Property.DIRECT_EXCHANGE_NAME, Property.UNROUTABLE_KEY, true,
        ...
        channel.basicPublish(Property.DIRECT_EXCHANGE_NAME, Property.ROUTABLE_KEY_1, true,
                new AMQP.BasicProperties.Builder()
                        .headers(headers)
                        .timestamp(Date.from(Instant.now()))
                        .messageId("2")
        ...
        channel.basicPublish(Property.TOPIC_EXCHANGE_NAME, "text.hello", true,
                new AMQP.BasicProperties.Builder()
                        .headers(headers)
                        .timestamp(Date.from(Instant.now()))
                        .messageId("3")
